...
export default function AgenDetails() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formGroup}>
        ...
        <Text style={styles.input}>{user_data?.data?.user?.fullName}</Text>
        {/* <TextInput
          style={styles.input}
      ...
      <View style={styles.formGroup}>
        ...
        <Text style={styles.input}>{user_data?.data?.user?.email}</Text>
      ...
      <View style={styles.formGroup}>
        ...
        {user_data?.data?.user?.roles?.map((role, index) => (
