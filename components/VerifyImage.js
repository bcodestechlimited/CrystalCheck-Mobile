...
const VerifyImage = ({ image_Date }) => {
  const data = useLocalSearchParams();

  console.log({
    kkk: data?.guarantorId,
  });
  ...
  const Verfymutaion = useMutation(
    (data_info) => {
      ...
      let newdata = {
        photo: data_info?.photo,
        signature: data_info?.signature,
    ...
    },
    {
      ...
      onError: (error) => {
        console.log({
          kkkmainerror: error?.response?.data,
        });
        Toast.show({
          type: "error",
  ...
  const handleVerification = async () => {
    try {
      ...
      let data = {
        ...
        photo: image_Date, //uploadedImageData?.secure_url,
      };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text>Name: {data?.guarantor_name}</Text>
        ...
        >
          Please verify the guarantor by comparing the image with the ones in
          the PDF to see if they match.
        </Text>
        <TouchableOpacity
          style={{
      ...
      <View style={{ flex: 0.5, borderWidth: 1, height: 300 }}>
        {image_Date && (
          <Image
      ...
      <View style={styles.webViewContainer}>
        ...
        {/* <WebView
          ...
          javaScriptEnabled={true}
          domStorageEnabled={true}
          onError={() => Alert.alert("Error", "Failed to load the PDF.")}
        /> */}
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              />
              <Text style={{ fontWeight: "700", fontSize: 28 }}>Verifying</Text>
              <Text
                style={{
                  textAlign: "center",
                  fontSize: 16,
...
const styles = StyleSheet.create({
  ...
  webViewContainer: { flex: 1, borderWidth: 1 },
